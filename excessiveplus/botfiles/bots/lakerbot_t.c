...
//
// Name:			LakerboT_c.c
// Function:		chat lines for LakerboT
...
chat "lakerbot"
{
	...
	{
		"fitta horru stor son. Did I say that out loud?";
		"played";
		"Hrmf. Luckily for you, this isn't QuakeWorld.";
		/*
	...
	type "death_cratered" //initiated when the bot is killed by taking "normal" falling damage
	{
		...
		"Alas, gravity, the universal truths apply to all. Even to ~LakerboT.";
		*/
		// 0 = enemy name
	} //end type
	...
	{
		"Why am I getting that 'dm4' feeling?";
		/*
	...
	{
		"I *told* Carmack to fix that radioactive leak. Would he listen?";
		/*
	...
	{
		"shot";
		"nice - your rail aim's improving";
		/*
	...
	{
		"Just you wait till I get one of those.";
		"Wanna sign my petition at www.bfgsarelame.com?";
		/*
	...
	{
		"TGI final. DM2. 1 frag lead, seconds left. He's trapped on the crusher half-dead! OMG! Kane shoots! Kane misses! :D";
		/*
